    ...
    <body>
        ...
        <div class="container">
    		...
    		<?php
                ...
                // get kitchen table
                $select = "SELECT * FROM OrdersToCook WHERE TableNum = $table_num";
                ...
                if ($done) {
                    ...
                    echo "<p><a class='btn btn-lg btn-primary' href='yourBill.php?table_num=$table_num' role='button'>Pay Now</a></p>";
